  ...
  <ion-page>
    <ion-header>
      <ion-toolbar>
        ...
        <ion-title>SQLite Encryption</ion-title>
      </ion-toolbar>
    </ion-header>
    <ion-content :fullscreen="true">
      <ion-header collapse="condense">
        <ion-toolbar>
          <ion-title size="large">SQLite Encryption</ion-title>
        </ion-toolbar>
      </ion-header>
      <ion-card>
        <ion-card-content>
