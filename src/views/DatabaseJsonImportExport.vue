  ...
  <ion-page>
    <ion-header>
      <ion-toolbar>
        ...
        <ion-title>SQLite JsonImport/Export</ion-title>
      </ion-toolbar>
    </ion-header>
    <ion-content :fullscreen="true">
      <ion-header collapse="condense">
        <ion-toolbar>
          <ion-title size="large">SQLite JsonImport/Export</ion-title>
        </ion-toolbar>
      </ion-header>
      <ion-card>
        <ion-card-content>
...
import JsonImportExportTest from '@/components/JsonImportExportTest.vue';
export default defineComponent({
  ...
  components: { IonPage, IonButtons, IonHeader, IonToolbar,
                ...
                IonCardContent, JsonImportExportTest }
});
</script>
<style>
h1 {
